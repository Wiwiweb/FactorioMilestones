...
presets = {
    ...
    ["Sea Block"] = {
        required_mods = {"bobplates", "bobelectronics", "angelsbioprocessing", "SeaBlock"},
        milestones = {
            {type="group",      name="Science"},
            {type="item",       name="automation-science-pack",        quantity=1},
            {type="item",       name="logistic-science-pack",          quantity=1},
            ...
            {type="group",      name="Kills"},
            {type="kill",       name="medium-worm",                    quantity=1},
            {type="kill",       name="big-worm",                       quantity=1},
            {type="kill",       name="behemoth-worm",                  quantity=1},
            {type="kill",       name="character",                      quantity=1, next="x5"},
        }
    },
    ...
    ["Sea Block (With Sea Block Pack)"] = {
        required_mods = {"bobplates", "bobelectronics", "bobtech", "angelsbioprocessing", "SeaBlock", "SeaBlockMetaPack"},
        milestones = {
            {type="group",      name="Science"},
            {type="item",       name="automation-science-pack",        quantity=1},
            {type="item",       name="logistic-science-pack",          quantity=1},
            ...
            {type="group",      name="Progress"},
            {type="item",       name="landfill-sand-3",                quantity=1},
            {type="item",       name="landfill-sand-3",                quantity=1000, next="x10"},
            {type="item",       name="locomotive",                     quantity=1},
            {type="item",       name="construction-robot",             quantity=1},
            {type="item",       name="antron",                         quantity=1},
            {type="item",       name="rocket-fuel",                    quantity=1},
    ...
    ["Industrial Revolution 3 + Special Projects"] = {
        ...
        milestones = {
            ...
            {type="item",       name="carbon-special-analysis",   quantity=2650},
            {type="item",       name="gold-special-analysis",     quantity=1},
            {type="item",       name="gold-special-analysis",     quantity=250},
            {type="item",       name="lead-special-analysis",     quantity=1},
            {type="item",       name="lead-special-analysis",     quantity=400},
            {type="item",       name="nickel-special-analysis",   quantity=1},
            {type="item",       name="nickel-special-analysis",   quantity=500},
            {type="item",       name="diamond-special-analysis",  quantity=1},
            {type="item",       name="diamond-special-analysis",  quantity=50},
            {type="item",       name="ruby-special-analysis",     quantity=1},
            {type="item",       name="ruby-special-analysis",     quantity=100},
            {type="item",       name="electrum-special-analysis", quantity=1},
            {type="item",       name="electrum-special-analysis", quantity=1000},
            {type="item",       name="helium-special-analysis",   quantity=1},
            {type="item",       name="helium-special-analysis",   quantity=120},
            {type="item",       name="hydrogen-special-analysis", quantity=1},
            {type="item",       name="hydrogen-special-analysis", quantity=1250},
            {type="item",       name="uranium-special-analysis",  quantity=1},
            {type="item",       name="uranium-special-analysis",  quantity=1200},
