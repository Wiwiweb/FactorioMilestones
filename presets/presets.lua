...
presets = {
    ...
    ["Pyanodon's Mods (Without AlienLife)"] = {
        required_mods = {"pycoalprocessing", "pyfusionenergy", "pyindustry", "pypetroleumhandling", "pyhightech"},
        milestones = {
            ...
            {type="group",      name="Logistic & Military"},
    ...
    ["Pyanodon's Mods"] = {
        required_mods = {"pycoalprocessing", "pyfusionenergy", "pyindustry", "pypetroleumhandling", "pyhightech", "pyalienlife"},
        milestones = {
            {type="group",      name="Automation"},
            {type="item",       name="flask",                         quantity=1},
            {type="item",       name="fawogae-substrate",             quantity=1},
            ...
            {type="group",      name="Py science pack"},
            {type="item",       name="plastic-bar",                   quantity=1},
